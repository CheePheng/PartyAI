...
export const PassPhoneScreen: React.FC<PassPhoneScreenProps> = ({ 
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full space-y-8 animate-fade-in max-w-md mx-auto w-full p-4">
      <div className="text-center space-y-2">
        <h3 className="text-xl text-gray-400 font-bold uppercase tracking-widest">Next Player</h3>
        <h2 className="text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-pink-500">
          {playerName}
        </h2>
      </div>
      
      <Card className="w-full p-8 flex flex-col items-center justify-center space-y-8 border-2 border-indigo-500/30 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-indigo-500/10 to-pink-500/10 pointer-events-none" />
        
        <div className="text-8xl animate-bounce z-10 filter drop-shadow-lg">📱</div>
